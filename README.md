...
Программа разработана на .NET Core 3.1 с использованием C# 8.0. Поставленные цели выполнены.
Замечания: 
  1. Формат архива не соответствует спецификации GZip.
  2. Производительность и загрузка процессора страдает от "бутылочного горлышка" в виде медленной ПЗУ. Максимальная производительность достигается с использованием NVMe SSD диска или в случае, когда файл буферизован ОС.
